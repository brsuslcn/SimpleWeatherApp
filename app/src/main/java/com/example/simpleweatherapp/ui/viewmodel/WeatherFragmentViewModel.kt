...
import com.example.simpleweatherapp.data.model.weather_model.Weather
...
@HiltViewModel
class WeatherFragmentViewModel @Inject constructor(private val weatherRepository: WeatherRepository) : ViewModel(){
